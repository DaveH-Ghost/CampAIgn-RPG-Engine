...
**Current release:** **1.5.0** — affinity memory module (relationships + rolling summary). See [changelog index](changelog/README.md). Library-first since 1.0; [Migration 0.7 → 1.0](MIGRATION-0.7-to-1.0.md) still applies for older upgrades.
