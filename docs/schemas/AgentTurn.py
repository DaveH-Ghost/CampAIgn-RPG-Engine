"""
AgentTurn Schema - Version 0

This file contains the current Pydantic schema for agent turn outputs in Version 0.

This schema is the single source of truth for what the LLM must return
every turn. The simulation will validate against this model.
...
Last updated: After Gap #5 validator strengthening (Path A)
"""
