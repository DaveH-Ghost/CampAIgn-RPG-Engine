...
Demo handlers registered by the `realm` CLI and realm-studio at startup. **Not** part of the engine — copy this pattern in your own app.
...
sys.path.insert(0, str(Path("examples")))  # repo root relative
