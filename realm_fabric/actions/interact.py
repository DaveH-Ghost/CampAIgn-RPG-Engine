...
from realm_fabric.interact_templates import InteractTemplateContext, format_interact_template
...
from realm_fabric.object import Object, chebyshev_distance_to_object
from realm_fabric.object_action import ObjectAction
from realm_fabric.interaction_handlers.registry import run_interaction_handler
from realm_fabric.occupancy import find_blocker_between, footprint_tiles_for_entity, is_tile_enterable

from realm_fabric.pathfinding import find_path, walk_with_pathfinding

from realm_fabric.perception import is_object_in_passive_vision, nearest_standable_in_interact_range
    ...
    *,
    ...
    if agent.move_speed is None:
        ...
        if session is not None and trigger_fired is not None and len(path) > 1:
            from realm_fabric.triggers import advance_agent_along_path
            ...
            if session is not None and trigger_fired is not None:
                from realm_fabric.triggers import evaluate_triggers_at_position
