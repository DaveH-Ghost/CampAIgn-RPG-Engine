...
app-owned command dispatch (Realm-Studio).
"""
...
from realm_fabric.area_edit_parse import parse_field_tokens, tokenize_args
...
from realm_fabric.object import Object, object_footprint_fits_bounds
from realm_fabric.object_action import ObjectAction
from realm_fabric.interaction_handlers.registry import validate_handler_params
from realm_fabric.reserved_names import (
...
def create_object_from_args(area: Area, arg: str) -> tuple[Optional[Object], str]:
    ...
    from realm_fabric.world_edit_api import create_object_from_fields
...
def create_agent_from_args(area: Area, arg: str) -> tuple[Optional[Agent], str]:
    ...
    from realm_fabric.world_edit_api import create_agent_from_fields
...
def edit_area_from_args(session: Session, arg: str):
    ...
    For app-owned command dispatch — not part of ``Session`` public API.
    """
    from realm_fabric.session_area_edit import AreaMutationResult, edit_area_in_session, validate_area_id
