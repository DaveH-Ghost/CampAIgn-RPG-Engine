...
from realm_fabric.area import Area, create_initial_area
from realm_fabric.agent import Agent
from realm_fabric.llm.prompt_context import PromptContext
...
class GameProfile:
    ...
    def build_prompt(
        ...
        *,
        ...
        from realm_fabric.lorebook.models import DEFAULT_LOREBOOK_CHAR_BUDGET
        from realm_fabric.prompt_blocks import render_prompt_blocks
