...
from realm_fabric.memory_modules.consolidation_runner import (
    ConsolidationRunner,
    ConsolidationSnapshot,
    ConsolidationState,
    MemoryConsolidationError,
)
from realm_fabric.memory_modules.formatting import (
    format_stored_turns_block,
    format_turns_batch_for_summary,
    join_lines,
)
from realm_fabric.memory_modules.serialization import (
...
from realm_fabric.turn_record import TurnRecord
