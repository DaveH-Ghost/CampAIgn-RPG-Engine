...
from realm_fabric.game_profile import GameProfile, default_compound_profile
...
from realm_fabric.world_edit_api import (
    WorldMutationResult,
...
class Session:
    ...
    def __init__(
        ...
        *,
        ...
        from realm_fabric.lorebook.models import DEFAULT_LOREBOOK_CHAR_BUDGET, Lorebook

        self._lorebooks: dict[str, Lorebook] = {}
        self.lorebook_char_budget = DEFAULT_LOREBOOK_CHAR_BUDGET
        from realm_fabric.lorebook.scan_config import LorebookScanConfig
    ...
    def transfer_object(
        ...
        from realm_fabric.object import object_footprint_fits_bounds
    ...
    def emit_area_event(
        ...
        *,
        ...
        from realm_fabric.observations import broadcast_area_event
    ...
    def list_lorebooks(self) -> list:
        ...
        from realm_fabric.lorebook.models import Lorebook
    ...
    def get_prompt_blocks(self) -> list:
        ...
        from realm_fabric.prompt_blocks import PromptBlock, default_prompt_blocks
    ...
    def snapshot(
        ...
        *,
        ...
        """
        from realm_fabric.snapshot import build_session_snapshot
    ...
    def to_save_dict(self) -> dict:
        ...
        from realm_fabric.session_persistence import build_save_snapshot
    ...
    def from_snapshot(cls, data: dict) -> Session:
        ...
        from realm_fabric.session_persistence import load_session_from_snapshot
    ...
    def format_debug_state(self, name_or_id: Optional[str] = None) -> str:
        ...
        from realm_fabric.memory_modules.registry import format_memory_module_label
    ...
    def _gate_agent_turn(self, agent: Agent) -> SessionResult:
        from realm_fabric.memory_modules.rolling_summary import MemoryConsolidationError
