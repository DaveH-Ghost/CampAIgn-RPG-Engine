...
from realm_fabric.area import Area, GridBounds, create_area
...
def parse_bounds_fields(fields: dict[str, str]) -> tuple[Optional[GridBounds], Optional[str]]:
...
def entities_outside_bounds(area: Area, bounds: GridBounds) -> Optional[str]:
