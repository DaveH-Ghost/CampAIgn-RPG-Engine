...
def count_speak_sentences(text: str) -> int:
    """
    Count sentences in speak content for validation.

    Runs of 2+ ASCII periods (..., ....) are treated as ellipses/pauses, not
    separate sentence boundaries. Single periods and ! ? still end sentences.
    """
